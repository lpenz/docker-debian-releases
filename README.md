...
information obtained from scrapping all available mirrors. The following scripts are in charge of this process:
...
link to the image in [docker hub](https://hub.docker.com/r/lpenz/).
Unfortunatelly, there's no way to link to a branch-specific page in
travis-ci ([issue #5024](https://github.com/travis-ci/travis-ci/issues/5024)),
so we had to link to the generic one - but the build result is
accurate.
